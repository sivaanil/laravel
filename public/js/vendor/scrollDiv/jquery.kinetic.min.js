    ...
    d.DATA_KEY = "kinetic", d.DEFAULTS = {
        ...
        this.settings.events = {
            touchStart: function (a) {
                var c;
                b._useTarget(a.target, a) && (c = a.originalEvent.touches[0], b._start(c.clientX, c.clientY), a.stopPropagation())
                ...
                b._useTarget(a.target, a) && (b._start(a.clientX, a.clientY), b.elementFocused = a.target, "IMG" === a.target.nodeName && a.preventDefault(), a.stopPropagation())
            }, inputEnd: function (a) {
        ...
        if ((!this.lastMove || new Date > new Date(this.lastMove.getTime() + this.throttleTimeout)) && (this.lastMove = new Date, this.mouseDown && (this.xpos || this.ypos))) {
            ...
            var e = this.scrollLeft(), f = this.scrollTop(), g = b - this.xpos, h = c - this.ypos;
