...
(function (e, t) {
    ...
    function y(t, n) {
        ...
        r = t.split(n);
        for (i = 0, s = r.length; i < s; i = i + 1)r[i] = e.trim(r[i]);
        return r
    }
    ...
    function O(e, t, n, r) {
        var i = d(e.toUpperCase()).indexOf(d(t.toUpperCase())), s = t.length;
        if (i < 0) {
            n.push(r(e));
            return
        }
    ...
    function _(n) {
        var r, i = null, s = n.quietMillis || 100, o = n.url, u = this;
        return function (a) {
            window.clearTimeout(r);
            r = window.setTimeout(function () {
                var r = n.data, s = o, f = n.transport || e.fn.select2.ajaxDefaults.transport, l = {
                    type: n.type || "GET",
                    cache: n.cache || false,
                ...
                e.extend(c, {
                    url: s, dataType: n.dataType, data: r, success: function (e) {
        ...
        return function (i) {
            ...
            if (e.isArray(u)) {
                e(u).each(function () {
                    ...
                    if (s === "" || i.matcher(s, n)) {
                        o.results.push(e ? this : {id: this, text: this})
                    }
                });
                i.callback(o)
            }
    ...
    var n, r, i, s, o, u, a = {x: 0, y: 0}, f, l, n = {
        TAB: 9,
        ENTER: 13,
        ESC: 27,
        SPACE: 32,
    ...
    }, c = "<div class='select2-measure-scrollbar'></div>", h = {
        "Ⓐ": "A",
        "Ａ": "A",
        "À": "A",
        "Á": "A",
    ...
    r = q(Object, {
        bind: function (e) {
            ...
            var e = this.opts.element, n = e.data("select2");
            this.close();
            ...
            if (e.is("option")) {
                ...
                return {text: e.attr("label"), children: [], element: e.get(), css: e.attr("class")}
            }
            ...
            n = e.extend({}, {
                populateResults: function (r, i, s) {
                    var u, f = this.opts.id, l = this.liveRegion;
                    u = function (r, i, c) {
                        ...
                        for (h = 0, p = r.length; h < p; h = h + 1) {
                            ...
                            b.attr("id", "select2-result-label-" + o());
                            b.attr("role", "option");
                            E = n.formatResult(d, b, s, a.opts.escapeMarkup);
                            if (E !== t) {
                                b.html(E);
                                y.append(b)
                            }
            ...
            if (i) {
                n.query = this.bind(function (e) {
                    var n = {results: [], more: false}, i = e.term, s, o, u;
                    u = function (t, n) {
                        var r;
                        if (t.is("option")) {
                    ...
                    if ("ajax"in n) {
                        ...
                        if (n.initSelection === t) {
                            n.initSelection = function (t, r) {
                                var i = [];
                                e(y(t.val(), n.separator)).each(function () {
                                    var t = {id: this, text: this}, r = n.tags;
            ...
            if (e.length && e[0].attachEvent) {
                e.each(function () {
                    this.attachEvent("onpropertychange", n)
                })
            }
            ...
            if (r !== t) {
                ...
                this.propertyObserver = new r(function (e) {
                    e.forEach(n)
                });
                this.propertyObserver.observe(e.get(0), {attributes: true, subtree: false})
            }
        }, triggerSelect: function (t) {
            var n = e.Event("select2-selecting", {val: this.id(t), object: t});
            ...
            if (E) {
                ...
                r = this.container.outerHeight(false);
                i = this.container.outerWidth(false);
                s = t.outerHeight(false);
                f = o.scrollLeft() + u;
                c = o.scrollTop() + a;
                h = n.top + r;
                p = n.left;
                m = t.outerWidth(false);
                g = p + m <= f;
                t.show();
                this.focusSearch()
            }
            if (this.opts.dropdownAutoWidth) {
                x = e(".select2-results", t)[0];
                t.addClass("select2-drop-auto-width");
                t.css("width", "");
                m = t.outerWidth(false) + (x.scrollHeight === x.clientHeight ? 0 : l.width);
                m > i ? i = m : m = i;
                s = t.outerHeight(false);
                g = p + m <= f
            } else {
            ...
            if (!g) {
                p = n.left + this.container.outerWidth(false) - m
            }
            S = {left: p, width: i};
            if (w) {
                S.top = n.top - s;
            ...
            var t = this.containerEventName, n = "scroll." + t, r = "resize." + t, i = "orientationchange." + t, s;
                ...
                s.on("mousedown touchstart click", function (t) {
                    ...
                    if (n.length > 0) {
                        ...
                        if (r.opts.selectOnBlur) {
                            r.selectHighlighted({noFocus: true})
                        }
                        r.close();
                        t.preventDefault();
                        t.stopPropagation()
            ...
            var t = this.containerEventName, n = "scroll." + t, r = "resize." + t, i = "orientationchange." + t;
            this.container.parents().add(window).each(function () {
            ...
            i = e(n[r]);
            s = i.offset().top + i.outerHeight(true);
            if (r === n.length - 1) {
            ...
            o = t.offset().top + t.outerHeight(true);
            if (s > o) {
            ...
            if (i) {
                this.opts.element.trigger({type: "select2-highlight", val: this.id(i), choice: i})
            }
            ...
            var e = this.results, t = e.find("li.select2-more-results"), n, r = this.resultsPage + 1, i = this, s = this.search.val(), o = this.context;
            ...
            if (n <= this.opts.loadMorePadding) {
                ...
                this.opts.query({
                    ...
                    callback: this.bind(function (n) {
                        if (!i.opened())return;
                        i.opts.populateResults.call(this, e, n.results, {term: s, page: r, context: o});
                        i.postprocessResults(n, false, false);
                        if (n.more === true) {
                            t.detach().appendTo(e).text(B(i.opts.formatLoadMore, r + 1));
                            window.setTimeout(function () {
                                i.loadMoreIfNeeded()
                            }, 10)
                        } else {
                        ...
                        i.resultsPage = r;
                        i.context = n.context;
                        this.opts.element.trigger({type: "select2-loaded", items: n})
                    })
                })
            }
        }, tokenize: function () {
            ...
            function h() {
                ...
                if (i.find(".select2-no-results,.select2-selection-limit,.select2-searching").length) {
                    ...
                    u.liveRegion.text(u.opts.formatMatches(i.find(".select2-result-selectable").length))
                }
            }
            ...
            var r = this.search, i = this.results, s = this.opts, o, u = this, a, f = r.val(), l = e.data(this.container, "select2-last-term"), c;
            ...
            if (d >= 1) {
                ...
                if (e.isArray(o) && o.length >= d && H(s.formatSelectionTooBig, "formatSelectionTooBig")) {
                    p("<li class='select2-selection-limit'>" + B(s.formatSelectionTooBig, d) + "</li>");
                    return
                }
            }
            if (r.val().length < s.minimumInputLength) {
                if (H(s.formatInputTooShort, "formatInputTooShort")) {
                    p("<li class='select2-no-results'>" + B(s.formatInputTooShort, r.val(), s.minimumInputLength) + "</li>")
                } else {
                    p("")
                }
            ...
            if (s.maximumInputLength && r.val().length > s.maximumInputLength) {
                if (H(s.formatInputTooLong, "formatInputTooLong")) {
                    p("<li class='select2-no-results'>" + B(s.formatInputTooLong, r.val(), s.maximumInputLength) + "</li>")
                } else {
                    p("")
                }
                return
            ...
            if (s.formatSearching && this.findHighlightableChoices().length === 0) {
                p("<li class='select2-searching'>" + B(s.formatSearching) + "</li>")
            }
            ...
            s.query({
                ...
                callback: this.bind(function (o) {
                    ...
                    if (o.results.length === 0 && H(s.formatNoMatches, "formatNoMatches")) {
                        p("<li class='select2-no-results'>" + B(s.formatNoMatches, r.val()) + "</li>");
                        return
                    }
                    i.empty();
                    ...
                    if (o.more === true && H(s.formatLoadMore, "formatLoadMore")) {
                        i.append("<li class='select2-more-results'>" + u.opts.escapeMarkup(B(s.formatLoadMore, this.resultsPage)) + "</li>");
                        window.setTimeout(function () {
                            u.loadMoreIfNeeded()
                        }, 10)
                    }
                    ...
                    h();
                    this.opts.element.trigger({type: "select2-loaded", items: o})
                })
            })
        }, cancel: function () {
            this.close()
    ...
    i = q(r, {
        createContainer: function () {
            ...
            var t, r = this.container, i = this.dropdown, s = o(), u;
            if (this.opts.minimumResultsForSearch < 0) {
            ...
            t.find(".select2-chosen").attr("id", "select2-chosen-" + s);
            ...
            u = e("label[for='" + this.opts.element.attr("id") + "']");
            this.focusser.prev().text(u.text()).attr("for", this.focusser.attr("id"));
            var a = this.opts.element.attr("title");
            this.opts.element.attr("title", a || u.text());
            ...
            this.focusser.on("keydown", this.bind(function (e) {
                ...
                if (this.opts.openOnEnter === false && e.which === n.ENTER) {
                    C(e);
                    return
                }
            ...
            if (this.isPlaceholderOptionSelected()) {
                ...
                this.opts.initSelection.call(null, this.opts.element, function (e) {
                    if (e !== t && e !== null) {
                        ...
                        n.close();
                        n.setPlaceholder();
                        n.nextSearchTerm = n.opts.nextSearchTerm(e, n.search.val())
                    }
                })
            }
            ...
            var t = this.parent.prepareOpts.apply(this, arguments), n = this;
            ...
            var n = this.opts.element.val(), r = this.data();
            ...
            if (!g(n, this.id(e))) {
                this.triggerChange({added: e, removed: r})
            }
        }, updateSelection: function (e) {
            var n = this.selection.find(".select2-chosen"), r, i;
            ...
            var e, n = false, r = null, i = this, s = this.data();
            if (arguments.length === 0) {
            ...
            if (this.select) {
                ...
                this.setPlaceholder();
                if (n) {
                    this.triggerChange({added: r, removed: s})
                }
            } else {
                if (!e && e !== 0) {
                    this.clear(n);
                ...
                this.opts.initSelection(this.opts.element, function (e) {
                    ...
                    i.setPlaceholder();
                    if (n) {
                        i.triggerChange({added: e, removed: s})
                    }
                })
            }
        }, clearSearch: function () {
            ...
            if (arguments.length === 0) {
                ...
                if (!e) {
                    ...
                    this.updateSelection(e);
                    if (r) {
                        this.triggerChange({added: e, removed: n})
                    }
                }
            }
        }
    ...
    s = q(r, {
        createContainer: function () {
            ...
            this.search.on("keydown", this.bind(function (e) {
                ...
                var i = t.prev(".select2-search-choice:not(.select2-locked)");
                ...
                if (t.length && (e.which == n.LEFT || e.which == n.RIGHT || e.which == n.BACKSPACE || e.which == n.DELETE || e.which == n.ENTER)) {
                    var u = t;
                    if (e.which == n.LEFT && i.length) {
                        u = i
                    } else if (e.which == n.RIGHT) {
                        u = s.length ? s : null
                    } else if (e.which === n.BACKSPACE) {
                        if (this.unselect(t.first())) {
                            this.search.width(10);
                            u = i.length ? i : s
                        }
                    } else if (e.which == n.DELETE) {
                        if (this.unselect(t.first())) {
                            this.search.width(10);
                            u = s.length ? s : null
                        }
                    } else if (e.which == n.ENTER) {
                        u = null
                    }
                    this.selectChoice(u);
                    C(e);
                    ...
                    return
                } else if ((e.which === n.BACKSPACE && this.keydowns == 1 || e.which == n.LEFT) && o.offset == 0 && !o.length) {
            ...
            var e = this.getPlaceholder(), n = this.getMaxSearchWidth();
            ...
            if (!n || !n.noFocus)this.focusSearch()
        }, cancel: function () {
            this.close();
            this.focusSearch()
        }, addSelectedChoice: function (n) {
            var r = !n.locked, i = e("<li class='select2-search-choice'>" + "    <div></div>" + "    <a href='#' class='select2-search-choice-close' tabindex='-1'></a>" + "</li>"), s = e("<li class='select2-search-choice select2-locked'>" + "<div></div>" + "</li>");
            var o = r ? i : s, u = this.id(n), a = this.getVal(), f, l;
            f = this.opts.formatSelection(n, o.find("div"), this.opts.escapeMarkup);
            if (f != t) {
                o.find("div").replaceWith("<div>" + f + "</div>")
            }
            ...
            var r = this.getVal(), i = this.results.find(".select2-result"), s = this.results.find(".select2-result-with-children"), o = this;
            ...
            if (!this.opts.createSearchChoice && !i.filter(".select2-result:not(.select2-selected)").length > 0) {
                if (!e || e && !e.more && this.results.find(".select2-no-results").length === 0) {
                    if (H(o.opts.formatNoMatches, "formatNoMatches")) {
                        this.results.append("<li class='select2-no-results'>" + B(o.opts.formatNoMatches, o.search.val()) + "</li>")
                    }
                }
            }
            ...
            if (this.select) {
                ...
                return y(e, this.opts.separator)
            }
        }, setVal: function (t) {
            var n;
            if (this.select) {
            ...
            if (!n && n !== 0) {
                ...
                this.clearSearch();
                if (r) {
                    this.triggerChange({added: this.data(), removed: i})
                }
                return
            }
            this.setVal(n);
    ...
    e.fn.select2 = function () {
        var n = Array.prototype.slice.call(arguments, 0), r, i, s, o, u, a = ["val", "destroy", "opened", "open", "close", "focus", "isFocused", "container", "dropdown", "onSortStart", "onSortEnd", "enable", "disable", "readonly", "positionDropdown", "data", "search"], f = ["opened", "isFocused", "container", "dropdown"], l = ["val", "data"], c = {search: "externalSearch"};
        this.each(function () {
    ...
    window.Select2 = {
        query: {ajax: _, local: D, tags: P},
        util: {debounce: S, markMatch: O, escapeMarkup: M, stripDiacritics: d},
        "class": {"abstract": r, single: i, multi: s}
    }
})(jQuery)