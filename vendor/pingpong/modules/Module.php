...
class Module extends ServiceProvider
{
    ...
    /**
     * API Handler for this Module
     *
     * @var Unified\Http\Controllers\Api\SegmentHandler
     */
    ...
    /**
     * Determine whether the current module has API handlers
     */
    public function hasAPI() {
        $path = $this->getExtraPath('Http/Controllers');
        if (file_exists($path."/APIHandler.php")) {
            return true;
        }
        return false;
    }
    ...
    /**
     * Return the API Segment handler for the current module
     *
     */
    public function getAPIHandler($folder) {
        if (empty($this->apiHandler)) {
            $classname = "Modules\\".$folder."\\Http\\Controllers\\APIHandler";
            $this->apiHandler = $classname;
        }
