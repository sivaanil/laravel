...
/**
 * API V1 Alarm Rule Types types handler.
 *
 * @author Igor Kondrakhin <igor.kondrakhin@csquaredsystems.com>
 */
final class AlarmRuleTypesProcessor extends ApiServiceRequest {
    public function __construct() {
        $description = [ 
                ResourceDescription::GET => [ 
                        ApiServiceRequest::API_SERVICE => 'Alarm',
                        ApiServiceRequest::API_SERVICE_ACTION => 'getAlarmRuleTypes',
