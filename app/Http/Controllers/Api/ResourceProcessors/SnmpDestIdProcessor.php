...
/**
 * API V1 SnmpDest/{ID} handler.
 *
 * @author Igor Kondrakhin <igor.kondrakhin@csquaredsystems.com>
 */
final class SnmpDestIdProcessor extends ApiServiceRequest {
    public function __construct() {
        ...
        $description = [ 
                ResourceDescription::GET => [ 
                        ...
                        ApiServiceRequest::API_SERVICE_ACTION => 'getSnmpDestById',
                ...
                ResourceDescription::PUT => [ 
                        ApiServiceRequest::API_SERVICE => 'SnmpDest',
                        ApiServiceRequest::API_SERVICE_ACTION => 'modifySnmpDest' 
                ],
                ResourceDescription::DELETE => [ 
                        ApiServiceRequest::API_SERVICE => 'SnmpDest',
                        ApiServiceRequest::API_SERVICE_ACTION => 'deleteSnmpDest' 
                ]
        ];
